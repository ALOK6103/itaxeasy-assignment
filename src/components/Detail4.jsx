...
const Detail4 = ({data}) => {
   ...
   return (
     ...
     <div style={{display:"flex",gap:"20px",alignItems:"center",justifyContent:"space-between",backgroundColor:"#E9E9E9",height:"50px",paddingLeft:"10px",paddingRight:"10px",width:"100%"}}>
       ...
       <input style={{height:"25px"}} type='number'  value={sum1 == 0 ? " " : sum1} onChange={(e) => setsum1(parseFloat(e.target.value))} />
     </div>
 
     <div style={{display:"flex",gap:"20px",alignItems:"center",justifyContent:"space-between",backgroundColor:"#E9E9E9",height:"50px",paddingLeft:"10px",paddingRight:"10px",width:"100%"}}>
       <label >Contribution to Agnipath Scheme (u/s 80CCH) </label>
       <input style={{height:"25px"}} type='number' value={sum2 == 0 ? " " : sum2} onChange={(e) => setsum2(parseFloat(e.target.value))}/>
     </div>
     </div>
   )
}
