      ...
      <div className='footer'>
        ...
        <div className='footer-first'>
          ...
          <div className="footer-first2">
              ...
              <div>
                  <img className='f2a1' src='https://incometaxindia.gov.in/PublishingImages/indiacodelogo.png' alt='img1'></img>
                  <img className='f2a1' src='https://incometaxindia.gov.in/_Layouts/15/images/dit/logoIndiagovin.png' alt='img2'></img>
                  <img className='f2a1' src='	https://incometaxindia.gov.in/_Layouts/15/images/dit/logostqc.jpg' alt='img3'></img>
              </div>
          </div>
        </div>
